...
const steps = [
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M21 7.00009L9 19.0001L3.5 13.5001L4.91 12.0901L9 16.1701L19.59 5.59009L21 7.00009Z" fill="currentColor"/>
      </svg>
    ),
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div 
              ...
              style={{
                left: '1.5rem', // Center of w-12 icon (3rem / 2 = 1.5rem)
                top: '1.5rem', // Start from center of first icon (half of w-12 = 1.5rem)
                // Height: from first icon center to bottom of last icon to ensure it reaches
                // Mobile: space-y-8 = 2rem, w-12 = 3rem
                // Calculation: (steps-1) × (spacing + icon) + half icon = 4 × (2rem + 3rem) + 1.5rem = 21.5rem
                // This ensures the line reaches the bottom edge of the last icon
                height: `${(steps.length - 1) * 5 + 1.5}rem`, // 20rem + 1.5rem = 21.5rem
              }}
            />
            {/* Desktop line */}
            <div 
              ...
              style={{
                left: '1.75rem', // Center of md:w-14 icon (3.5rem / 2 = 1.75rem)
                top: '1.75rem', // Start from center of first icon (half of md:w-14 = 1.75rem)
                // Height: from first icon center to bottom of last icon to ensure it reaches
                // Desktop: space-y-12 = 3rem, md:w-14 = 3.5rem
                // Calculation: (steps-1) × (spacing + icon) + half icon = 4 × (3rem + 3.5rem) + 1.75rem = 27.75rem
                // This ensures the line reaches the bottom edge of the last icon
                height: `${(steps.length - 1) * 6.5 + 1.75}rem`, // 26rem + 1.75rem = 27.75rem
              }}
            />
                  ...
                  >
                    ...
                    <div className="flex-1 pt-1">
                      {isActive ? (
                        ...
                        <div>
                          <h3 className="text-base md:text-lg font-medium text-gray-600 group-hover:text-[#7B00E0] transition-colors duration-300">
                            {step.title}
                          </h3>
                        </div>
                      )}
