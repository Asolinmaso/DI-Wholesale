          ...
          >
            <div className="relative">
              <Input
                ...
                className="w-full h-11 sm:h-12 md:h-14 rounded-full bg-white/95 text-gray-900 placeholder:text-gray-500 pl-4 pr-12 sm:pr-14 text-sm sm:text-base focus:bg-white transition-all duration-300 hover:bg-white"
              />
              <button
                type="submit"
                className="absolute right-1.5 sm:right-2 top-1/2 -translate-y-1/2 h-9 w-9 sm:h-10 sm:w-10 md:h-12 md:w-12 rounded-full bg-[#7B00E0] hover:bg-[#6A00C7] text-white flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="Search"
              >
